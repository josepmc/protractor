...
export class ProtractorBrowser extends AbstractExtendedWebDriver {
  ...
  /**
   * If true, the browser was created as part of the 'helperBrowsers' property
   */
  helper?: boolean;
  ...
  /**
   * Sets this browser as the 'main' browser. All the calls to 'protractor.browser' or to
   * 'globals.browser' will refer to 'this' now.
   */
  setBrowser: () => ProtractorBrowser;
