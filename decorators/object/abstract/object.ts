...
import { dirty, FnNames, generateName, isMetadataField } from '../core/decorators';
import { IConstructor, IDataModelObject, IImplementable, classExtensionDecorator } from '../core';
import { propertyDescriptor, InitMode, InitOpts, injectKey, InjectArgs } from '../core/iConstructor';
import { internal, internalKey } from '../core/shared';
...
export abstract class AbstractObject<I extends AbstractObjectInitOpts = AbstractObjectInitOpts> extends IImplementable<I> {
    ...
    public static async WaitForPage<T extends IImplementable>(pages: any[],
